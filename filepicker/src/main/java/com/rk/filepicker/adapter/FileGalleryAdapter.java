...
package com.rk.filepicker.adapter;
...
import com.rk.filepicker.utils.FilePickerProvider;
import com.rk.filepicker.utils.TimeUtils;
import com.rk.filepicker.view.SquareImage;
...
public class FileGalleryAdapter extends MultiSelectionAdapter<FileGalleryAdapter.ViewHolder>
    ...
    public void openCamera(boolean forVideo) {
        ...
        boolean per =  (ContextCompat.checkSelfPermission(activity, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) ;
        Log.d("tien.hien","per = "+per);
